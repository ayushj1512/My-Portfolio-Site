...
const focusAreas = [
  ...
  },
  {
    title: "Generative AI",
    icon: Bot,
    description: "Building innovative AI-driven applications for smarter user experiences.",
  },
  {
...
export default function FocusAreas() {
  return (
    <section className="py-20 px-20 relative w-full">
      {/* Section Header */}
      <motion.div
      ...
      >
        ...
        {/* (Keeping your glow style, though it wasn't used directly) */}
        <style jsx>{`
      ...
      {/* ✅ Flex layout (no max-w, no grid) */}
      <div className="w-full px-6 flex flex-wrap justify-center gap-10">
